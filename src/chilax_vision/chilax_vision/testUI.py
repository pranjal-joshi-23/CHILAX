...
arrow_size = 30  # length of arrow in pixels
thickness = 3
...
while True:
    ...
    # arrow_x = frame_width // 8 + arrow_width // 2
    # arrow_y = (frame_height + arrow_height) // 2
    ...
    cv2.ellipse(frame, (frame_width//2, frame_height//2), (100, 125), 0, 0, 360, base_color, 2)
    ...
    for i in [1, 2, 3]:
        ...
        cv2.arrowedLine(frame, (cx + arrow_size // 2, cy), (cx - arrow_size // 2, cy), base_color, thickness, tipLength=tipLength)
    ...
    cv2.arrowedLine(frame, (cx, cy + arrow_size // 2), (cx, cy - arrow_size // 2), base_color, thickness, tipLength=0.6)
